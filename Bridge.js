...
export async function bridgeTokens(walletType, recvAddress, amount, destinationChain, currentAccount) {
...
async function burnTokensOnEth(amount, destinationChain) {
  try {
    ...
    const contractAddress = "0x5FbDB2315678afecb367f032d93F642f64180aa3"; //deploy to  meta
...
export async function burnTokensOnSui(amount, currentAccount) {
  try {
    ...
    const IBTTOKEN_TYPE = "0x47efef0b0d5f7f5feb92fae5849b4aeb4ca3d88d585dc4ba8ac9a6569b91514e::IBTToken::IBTToken";  ////pk id sui
